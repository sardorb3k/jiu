                    ...
                    <div class="nk-header-wrap">
                        ...
                        <div class="nk-header-brand">
                            <a href="{{ url('/dashboard') }}" class="logo-link">
                                <img class="logo-light logo-img" src="{{ asset('uploads/logo-white.png') }}"
                                    srcset="{{ asset('uploads/logo-white.png') }}" alt="logo">
                                <img class="logo-dark logo-img" src="{{ asset('uploads/logo-black.png') }}"
                                    srcset="{{ asset('uploads/logo-black.png') }}" alt="logo-dark">
                            </a>
                        </div><!-- .nk-header-brand -->
                                ...
                                <li class="dropdown language-dropdown d-none d-sm-flex me-n1">
                                    <a href="#" class="dropdown-toggle nk-quick-nav-icon"
                                        ...
                                        <div class="quick-icon">
                                            <img class="icon"
                                                src="{{ asset('assets/images/flags/' . Config::get('languages')[App::getLocale()]['flag-icon'] . '.png') }}"
                                                alt="">
                                        </div>
                                    </a>
                                                ...
                                                @if ($lang != App::getLocale())
                                                    <li>
                                                        <a href="{{ route('lang.switch', $lang) }}"
                                                            class="language-item">
                                                            <img src="{{ url('assets/images/flags/' . $language['flag-icon'] . '.png') }}"
